...
function ILILCE() {
    ...
    function eachIlBolge(data) {
        ...
        $.each(data, function (index, value) {
            ...
            iller += '<option value="' + value.il + '" title="' + value.il + '" data-plaka="' + value.plaka + '" data-bolge="' + value.bolge + '" >' + value.il + '</option>';
    ...
    function eachIlIlce(data) {
        ...
        $.each(data, function (index, value) {
            if (value.il == selectFormIlname) {
                var ilceler = "";
                ilceler += '<option value="' + value.ilce + '" data-il="' + value.il + '" data-plaka="' + value.plaka + '"  data-bolge="' + value.bolge + '" >' + value.ilce + '</option>';
...
function clipb() {
    ...
    if (!$(document).find('.copy-clipboard').length) return false;
...
function searchMapWrapperRightSideBody() {
